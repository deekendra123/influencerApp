package com.fitnytech.influencerApp.development
...
import com.fitnytech.influencerApp.development.databinding.ActivityMediaBinding
...
class MediaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initBinding(R.layout.activity_media)
        test(null)
    }
